...
export function useCaptions() {
    ...
    const lastSelectedLanguage = useSubtitleStore(
        (s) => s.lastSelectedLanguage,
    );
    ...
    const getSubtitleTracks = usePlayerStore(
        (s) => s.display?.getSubtitleTracks,
    );
