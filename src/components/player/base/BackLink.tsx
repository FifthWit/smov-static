...
export function BackLink(props: { url: string }) {
  ...
  return (
    ...
    <SidebarTrigger className="mr-4" />
      <Link
        to={props.url}
        className="py-1 -my-1 px-2 -mx-2 tabbable rounded-lg flex items-center cursor-pointer text-type-secondary hover:text-foreground transition-colors duration-200 font-medium"
      >
