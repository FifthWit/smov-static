...
const borderClass = "pb-4 border-b border-border border-opacity-50";

export function Heading1(props: TextProps) {
    return (
        <h1
            className={[
                "text-3xl lg:text-5xl font-bold text-foreground mb-9",
...
export function Heading2(props: TextProps) {
    return (
        <h2
            className={[
                "text-xl lg:text-2xl font-bold text-foreground mt-20 mb-9",
                props.border ? borderClass : null,
                props.className ?? "",
            ].join(" ")}
        >
...
export function Heading3(props: TextProps) {
    return (
        <h2
            className={[
                "text-lg lg:text-xl font-bold text-foreground mb-3",
                props.border ? borderClass : null,
                props.className ?? "",
            ].join(" ")}
        >
