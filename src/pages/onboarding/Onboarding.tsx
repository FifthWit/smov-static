                ...
                <div className="w-full flex flex-col md:flex-row gap-3">
                    <Card onClick={() => navigate("/onboarding/extension")}>
                        <CardContent
                            ...
                            title={t(
                                "onboarding.start.options.extension.title",
                            )}
                            subtitle={t(
                                "onboarding.start.options.extension.quality",
                            )}
                            description={t(
                                "onboarding.start.options.extension.description",
                            )}
                        >
                            <Link>
                    ...
                    <Card onClick={() => navigate("/onboarding/proxy")}>
                        <CardContent
                            ...
                            subtitle={t(
                                "onboarding.start.options.proxy.quality",
                            )}
                            description={t(
                                "onboarding.start.options.proxy.description",
                            )}
                        >
                            <Link>
